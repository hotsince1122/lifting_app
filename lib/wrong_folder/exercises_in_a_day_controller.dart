...
final exercisesInADayProvider =
    AsyncNotifierProvider.family<
      ExercisesInADayController,
      List<Exercise>,
      String
    >(ExercisesInADayController.new);

class ExercisesInADayController extends AsyncNotifier<List<Exercise>> {
  ExercisesInADayController(this.dayId);
