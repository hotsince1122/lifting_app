...
final weeklyWorkoutProgressProvider =
    AsyncNotifierProvider<WorkoutsPerWeekController, WeeklyWorkoutProgress>(
      WorkoutsPerWeekController.new,
    );

class WorkoutsPerWeekController extends AsyncNotifier<WeeklyWorkoutProgress> {
  @override
