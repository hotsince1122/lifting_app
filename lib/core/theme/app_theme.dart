...
class AppTheme {
  static ThemeData dark = ThemeData(
    ...
    textTheme: GoogleFonts.interTextTheme().copyWith(
      ...
      ), //Pentru: titluri de ecran și secțiuni importante
      ...
      titleLarge: GoogleFonts.inter(
        fontSize: 18,
        fontWeight: FontWeight.w600,
      ), //Pentru: titluri de card, titlu de exercițiu, elemente principale într-un card
      ...
      bodyLarge: GoogleFonts.inter(
        fontSize: 16,
        height: 1.3,
      ), //Pentru: text normal important, descrieri scurte, value text
      bodyMedium: GoogleFonts.inter(
        fontSize: 14,
        height: 1.3,
      ), //Pentru: text normal secundar, liste, rânduri
      bodySmall: GoogleFonts.inter(
        fontSize: 12,
        height: 1.3,
      ), //Pentru: hint-uri, micro-copy, subtext, note

      labelLarge: GoogleFonts.inter(
        fontSize: 12,
        fontWeight: FontWeight.w600,
      ), //Pentru: butoane, chip-uri, CTA text
